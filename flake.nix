{
  description = "Thermal Conductivity Equation Solver";
      ...
      let
        ...
        pythonProject = pkgs.stdenv.mkDerivation {
          ...
          installPhase = ''
            ...
            cp -r . $out/lib/python/
            cat > $out/bin/thermal_solver_py <<EOF
            ...
            main()
            EOF
            chmod +x $out/bin/thermal_solver_py
          '';
        };
